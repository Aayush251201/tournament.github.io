...
(function() {
    ...
    btnf = document.getElementById('btnlog');
            ...
            var databaset = firebase.database().ref().child("cod").child('morning');
        ...
        var noofelements=0;
                ...
                var key = Object.keys(snap.val())[i];
                     ...
                     var test2=  firebase.database().ref().child("cod").child('morning').child(key.toString());
    ...
    //               div3.className ="eventplaceclass";
            ...
            var databasetgg = firebase.database().ref().child("cod").child('afternoon');
    ...
    //            preobjectf.innerText = JSON.stringify(snap.val(), null, 3);
              ...
              var test2=  firebase.database().ref().child("cod").child('afternoon').child(key.toString());
              test2.on('value',function(snapshot){
    //           snapshot.forEach(function(childSnapshot){
                   var childdata=snapshot.val();
                    var div1 = document.createElement("div");
    ...
    var databasetgg = firebase.database().ref().child("cod").child('upcoming');
    databasetgg.on('value', snap => {
    ...
    //            preobjectf.innerText = JSON.stringify(snap.val(), null, 3);
      ...
      var test23=  firebase.database().ref().child("cod").child('upcoming').child(key.toString());
    ...
    //               div3.className ="eventplaceclass";
          ...
          div4.appendChild(h5124); 
           ...
           preobjectfdd.appendChild(hr9);
            ...
            var databaset = firebase.database().ref().child("cod").child('night');
            databaset.on('value', snap => {
                    console.log(snap.val());
                    var noofelements=0;
                  for(var j=0;j<10;j++){
                ...
                for(var i=0;i<noofelements;i++){
                var key = Object.keys(snap.val())[i];
                       var test2=  firebase.database().ref().child("cod").child('night').child(key.toString());
              test2.on('value',function(snapshot){
    //           snapshot.forEach(function(childSnapshot){
                   var childdata=snapshot.val();
                    var div1 = document.createElement("div");
    ...
    function onde(valuey){
      pretime =document.getElementById(valuey+"gg").value;
        ...
        document.getElementById("qwg").innerHTML = "";}
          ...
          var testing78=firebase.database().ref().child("cod").child("upcoming").child(valuey.toString());
      ...
      document.getElementById("validationCustom021abcl001").value= childdata95['discord'];
        ...
        firebase.database().ref().child("cod").child(pretime).push({
    ...
    function ondelete(value){firebase.database().ref().child("cod").child("morning").child(value.toString()).remove();location.reload();}
    function ondelete1(value){firebase.database().ref().child("cod").child("afternoon").child(value.toString()).remove();location.reload();}
    function ondelete2(value){firebase.database().ref().child("cod").child("night").child(value.toString()).remove();location.reload();}
    function ondelete12(value){firebase.database().ref().child("cod").child("upcoming").child(value.toString()).remove();location.reload();}
    
    
    
    var string3="wowo";
    function update(value){document.getElementById("adminpanel6").style.display="block";
        var testing=firebase.database().ref().child("cod").child("morning").child(value.toString());
    ...
    function update1(value){document.getElementById("adminpanel6").style.display="block";
        var testing=firebase.database().ref().child("cod").child("afternoon").child(value.toString());
        testing.on('value',function(snapshot){
            var childdata9=snapshot.val();
            document.getElementById("inputGroupSelect02789").value= childdata9['registration_status'];
                    document.getElementById("validationCustom029").value= childdata9['eventplace'];
    ...
    function update2(value){
        ...
        var testing=firebase.database().ref().child("cod").child("night").child(value.toString());
        testing.on('value',function(snapshot){
            var childdata9=snapshot.val();
            document.getElementById("inputGroupSelect02789").value= childdata9['registration_status'];
                    document.getElementById("validationCustom029").value= childdata9['eventplace'];
    ...
    function update21(value){
      document.getElementById("adminpanel6").style.display="block";
      var testing=firebase.database().ref().child("cod").child("upcoming").child(value.toString());
      testing.on('value',function(snapshot){
          var childdata9=snapshot.val();
          document.getElementById("inputGroupSelect02789").value= childdata9['registration_status'];
                  document.getElementById("validationCustom029").value= childdata9['eventplace'];
    ...
    function updatedata(value){
        ...
        firebase.database().ref().child("cod").child(saved_data).child(value.toString()).set({
            eventslot:document.getElementById("inputGroupSelect029").value,
            eventslotclass:"eventslotclass",
            banner:document.getElementById("vali9").value,
            bannerclass:"bannerclass",
