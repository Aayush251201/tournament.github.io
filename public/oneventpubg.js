...
(function() {
    ...
    btnf = document.getElementById('btnlog');
           ...
           var test2 = firebase.database().ref().child("pubg").child(storage2).child(storage);
    ...
    //           snapshot.forEach(function(childSnapshot){
                ...
                //    if(childdata['entryfee']==0){document.getElementById("mybtn22").style.display="none";
                //    document.getElementById("mybtn221").style.display="inline";
                //    document.getElementById("mybtn221").disabled="false";
                // }else{
                //         document.getElementById("mybtn22").style.display="inline";
                //         document.getElementById("mybtn221").style.display="none";
                //    }

                //    document.getElementById("mybtn221").onclick= changeListener1;
                //    function changeListener1(){
               
                          
   
   
                //                                    document.lolp1.submit();
