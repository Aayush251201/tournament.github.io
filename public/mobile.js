...
(function() {
        ...
        var firebaseConfig = {
              ...
              `<a href="./oneevent.html" class="event-anchor"  id="${key.toString()}" onclick="onveiw(this.id)">
              <div class="row-flex"  data-aos="fade-up">
                  ...
                  <div style="display: block;">
                      ...
                      <p class="event-creator" style="color: black;">LUDO-By ${childdata['organizer'].toUpperCase()}</p>
                  </div>
        ...
        //           snapshot.forEach(function(childSnapshot){
                        ...
                        `<a href="./oneevent.html" class="event-anchor"  id="${key.toString()}" onclick="onveiw1(this.id)">
                        <div class="row-flex"  data-aos="fade-up">
        ...
        //           snapshot.forEach(function(childSnapshot){
                        ...
                        `<a href="./oneevent.html" class="event-anchor"  id="${key.toString()}" onclick="onveiw2(this.id)">
                        <div class="row-flex"  data-aos="fade-up">
        ...
        <div class="row-flex"  data-aos="fade-up">
            ...
            <div style="display: block;text-align: center!important;">
                ...
                var databaset = firebase.database().ref().child("ludo").child('upcoming');
                databaset.on('value', snap => {
                console.log(snap.val());
                        var noofelements = 0;
                        for (var j = 0; j < 10; j++){
                ...
                var key = Object.keys(snap.val())[i];
                        var test2 = firebase.database().ref().child("ludo").child('upcoming').child(key.toString());
                        test2.on('value', function(snapshot){
        ...
        `<a href="./oneevent.html" class="event-anchor"  id="${key.toString()}" onclick="onveiw21(this.id)">
        <div class="row-flex"  data-aos="fade-up">
