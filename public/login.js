...
var firebaseConfig = {
  apiKey: "AIzaSyCtWtXifmXNjyDhVClnApzKacpuhmnfWP0",
    ...
    measurementId: "G-LXQWECD8CZ"
        ...
        emailf = document.getElementById('validationCustom03');
        passf = document.getElementById('validationCustom04');
        btnloginf = document.getElementById('btnlogin');
        btnloginf.addEventListener('click', e => {
        emailff = emailf.value;
                passff = passf.value;
                authf = firebase.auth();
                promise = authf.signInWithEmailAndPassword(emailff, passff);
                promise.catch(e => {var dataoutput="";
                dataoutput44=e.message.toString();

                var tt=document.getElementById("popl2");
